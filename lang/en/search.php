...
$string['engineerror'] = '{$a} engine server not ready, check its status.';
$string['enteryoursearchquery'] = 'Enter your search query';
$string['errors'] = 'Errors';
$string['errorcomponentnotavailable'] = '{$a} search component is not available.';
...
$string['subsystemname'] = 'Core {$a} subsystem';
