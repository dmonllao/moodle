...
$string['timesplitting:onemonthafterstart'] = 'One month after the start';
$string['timesplitting:onemonthafterstart_help'] = 'This time-splitting method generates predictions 1 month after the analysable start. The indicators calculations will be based on the past month.';
$string['timesplitting:oneweekafterstart'] = 'One week after the start';
$string['timesplitting:oneweekafterstart_help'] = 'This time-splitting method generates predictions 1 week after the analysable start. The indicators calculations will be based on the past week.';
$string['timesplitting:threedaysafterstart'] = 'Three days after the start';
$string['timesplitting:threedaysafterstart_help'] = 'This time-splitting method generates predictions 3 days after the analysable start. The indicators calculations will be based on the past 3 days.';
$string['timesplitting:past3days'] = 'Past 3 days';
$string['timesplitting:past3days_help'] = 'This time-splitting method generates predictions every 3 days. The indicators calculations will be based on the past 3 days.';
$string['timesplitting:pastmonth'] = 'Past month';
$string['timesplitting:pastmonth_help'] = 'This time-splitting method generates predictions every month. The indicators calculations will be based on the past month.';
$string['timesplitting:pastweek'] = 'Past week';
$string['timesplitting:pastweek_help'] = 'This time-splitting method generates predictions every week. The indicators calculations will be based on the past week.';
