...
$string['tags'] = 'Tags';
$string['target:coursecompletion'] = 'Students at risk of not meeting the completion criteria';
$string['target:coursecompletion_help'] = 'This target describes whether the student could not complete the course according to the course completion requirements';
...
$string['targetlabelstudentcompletionno'] = 'Student who might not achieve the completion criteria of the course';
...
$string['timesplitting:upcoming3days_help'] = 'This time-splitting method generates predictions in weekly basis. The indicators calculations will be based on the upcoming 3 days.';
