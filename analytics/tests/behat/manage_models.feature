...
Feature: Manage analytics models
  ...
  Scenario: Create a model
    ...
    And I set the field "Indicators" to "Read actions amount"
    And I set the field "Indicators" to "Any write action in the course"
  ...
  Scenario: Evaluate a model
    ...
    And I navigate to "Analytics > Analytics models" in site administration
    # View predictions
    When I select "Course: C3" from the "contextid" singleselect
