...
class dataset_manager {
    ...
    public function store($data) {
        ...
        $filerecord = [
            ...
            'filepath' => '/analysable/' . $this->analysableid . '/' . \core_analytics\analysis::clean_time_splitting_id($this->timesplittingid) . '/',
    ...
    public static function get_previous_evaluation_file($modelid, $timesplittingid) {
        ...
        return $fs->get_file(\context_system::instance()->id, 'analytics', self::LABELLED_FILEAREA, $modelid,
            '/timesplitting/' . \core_analytics\analysis::clean_time_splitting_id($timesplittingid) . '/', self::EVALUATION_FILENAME);
    }
    ...
    public static function get_evaluation_analysable_file($modelid, $analysableid, $timesplittingid) {
        ...
        $filepath = '/analysable/' . $analysableid . '/' . \core_analytics\analysis::clean_time_splitting_id($timesplittingid) . '/';
