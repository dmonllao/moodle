...
If the cache is shared by other applications then each key will be deleted individually to ensure that only data owned by this application is purged (leaving external application cache data in tact). This can result in reduced performance when purging the cache, depending on your server configuration.
