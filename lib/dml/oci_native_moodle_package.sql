...
FUNCTION TRICONCAT(string1 IN CLOB, string2 IN CLOB, string3 IN CLOB) RETURN VARCHAR2;
...
FUNCTION TRICONCAT(string1 IN CLOB, string2 IN CLOB, string3 IN CLOB) RETURN VARCHAR2 IS
    stringresult CLOB;
BEGIN
