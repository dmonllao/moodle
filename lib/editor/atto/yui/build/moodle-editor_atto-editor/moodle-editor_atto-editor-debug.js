    ...
    setupSelectionWatchers: function() {
        ...
        this.editor.on('drop', function(e) {
                ...
                Y.soon(Y.bind(function(e) {
                    ...
                    // We need to check that dataTransfer object is available and it returns valid types.
                    if (e._event.dataTransfer && e._event.dataTransfer.types[0]) {
                    ...
                    if (!selection[0].collapsed || !container || !container.getDOMNode().firstChild) {
